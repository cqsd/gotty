This is a fork of GoTTY with a recording feature. For documentation on recording and installing, see the [readme appendix](./README-APPENDIX.md).

The original README follows. FYI the installation instructions have changed!
